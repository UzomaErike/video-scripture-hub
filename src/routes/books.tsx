...
function BookCard({
  ...
  return (
    ...
    >
      ...
      <span className="absolute top-1.5 right-1.5 z-10 inline-flex items-center rounded-full bg-background/85 backdrop-blur border border-border px-2 py-0.5 text-xs font-medium text-primary">

...
import { BookOpen, Menu, Headphones, FileText, MessageSquareQuote, Heart, Mail, Settings, Clapperboard, Music, ShoppingBag } from "lucide-react";
...
const navItems: NavItem[] = [
  { label: "Shop Bible Resources", to: "/shop", icon: ShoppingBag },
